...
<div class="card mb-5" style="border-radius: 25px;">
    <form action="blog">
        <div class="input-group">
            <input class="form-control" name="key" value="${key}"  type="text" placeholder="Search" aria-label="Enter search term..." aria-describedby="button-search" style="border-radius: 25px 0px 0px 25px"/>
            <button class="btn btn-dark" id="button-search" type="submit" style="border-radius: 0px 25px 25px 0px">Search</button>
        </div>
    </form>
</div>
<!-- Categories widget-->
