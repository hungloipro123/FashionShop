        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse ms-5" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item me-4">
                        <a class="nav-link" href="https://www.facebook.com/huynhhungloi1">Contact</a>
                    </li>


                </ul>
                <form class="d-flex me-5" action="list">
                    <input class="form-control me-2" style="border-radius: 10px" type="text" name ="key" placeholder="Find product ..." aria-label="Search" value="${key}" id="" required class="form-control">
                    <button class="btn btn-outline-dark" style="border-radius: 10px " type="submit">Search</button>
                </form>
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu menuScroll">
                                <li><a class="dropdown-item" type="button" data-toggle="modal"  data-target="#userProfileModal">User Information</a></li>
                                    ...
                                    <li><a class="dropdown-item" href="mkt-dashboard">Quảnlýtiếp thị</a></li>
                                    </c:if>
                    ...
                    <c:if test="${sessionScope.us == null}">
                        <li class="nav-item">
                            <a><i type="button" class="ti-user btn btn-icon py-2 px-4 " style="color:black; font-size: 20px;" data-toggle="modal"  data-target="#loginModal"></i></a>
                        </li>
                    </c:if>
                    <!-- begin icon header -->
                    <c:if test="${sessionScope.us.role_Id == 1 || sessionScope.us == null}">
                        <li class="nav-item">
                            <a class="nav-link btn btn-icon py-2 px-4" style="color:black; font-size: 20px;" href="carts" tabindex="-1" aria-disabled="true"><i class="ti-shopping-cart"></i></a>
                        </li>
                    </c:if>
                </ul>
