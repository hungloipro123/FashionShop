...
<nav class="sb-topnav navbar navbar-expand navbar-light bg-light    ">
            ...
            <div class="collapse navbar-collapse ms-5" id="navbarSupportedContent">
                ...
                <form class="d-flex me-5" action="list">
                    <input class="form-control me-2" type="text" name ="key" placeholder="Search..." aria-label="Search" value="${key}" id="" required class="form-control">
                    ...
                    <c:if test="${sessionScope.us != null}">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" type="button" data-toggle="modal"  data-target="#userProfileModal">User Profile</a></li>
