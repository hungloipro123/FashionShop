                            ...
                            <div class="d-flex  small text-warning mb-2">
                                ...
                                <c:forEach var="i" begin="0" end="4">
                                    <c:if test="${(product.rated_star - i) >= 1}">
                                        <div style="width: 13px;height: 13px;" class="reviews-rating__star is-active"></div> 
                                    </c:if>
                                    <c:if test="${(product.rated_star - i) < 1 && (product.rated_star - i) > 0}">
                                        <div  style="width: 13px;height: 13px;" class="reviews-rating__star is-active is-half" ></div> 
                                    </c:if>
                                    <c:if test="${(product.rated_star - i) <= 0}">
                                        <div style="width: 13px;height: 13px;" class="reviews-rating__star"></div> 
                                    </c:if>
...
<!--                            <div class="pd-color">
                ...
                <div class="row gx-4 gx-lg-5 align-items-center" style="padding-top: 10%">
                    <p class="lead" style="font-weight: 700;">${product.brief_infor}</p>
                    <p class="lead" style="font-weight: 700;">${product.desciption}</p>
                </div>
            </div>
        </section>
